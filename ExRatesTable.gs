CryptoTracker.prototype.exRatesTable = function () {
  ...
  sheet.getRange('B3').setFormula(`=ArrayFormula(VLOOKUP(FILTER(A3:A, LEN(A3:A))&$B$1 ,{'${referenceSheetName}'!B2:B&'${referenceSheetName}'!C2:C,'${referenceSheetName}'!D2:D}, 2, FALSE))`);
